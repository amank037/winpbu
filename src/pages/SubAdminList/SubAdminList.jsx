...
function SubAdminList() {
  return (
    <div>
        <div className='sub-admin-div2'>
            <div className='sub-admin-container'>
                <div className='sub-admin-left'>
                    <div className='sub-admin-left-top'>
                        <img className='sub-admin-img' src="https://winpibu.com/wp-content/uploads/2025/03/sub-admin.jpg" alt="" />
                        <h2 className='sub-admin-left-top-title'>Sub Admin List</h2>
                        <p className='sub-admin-left-top-date'>January 31, 2025</p>
                    </div>

                    <p className='sub-admin-left-form-title'>এজেন্ট এর আইডি নাম্বার দিয়ে খুজুনঃ</p>

                    <div className='sub-admin-left-form'>
                        <AgentForm />
                    </div>

                    <div className='sub-admin-left-desc'>
                    ...
                    <div className='sub-admin-left-table'>
                        <table>
                            <thead>
                                <tr>
                                    <th>ID NO</th>
                            ...
                            <tbody>
                                {listData.map((item, index) => (
                                    <tr key={index}>
                                        ...
                                        <td>
                                            <a href=''>
                                                <img className='sub-admin-left-table-wa-img' 
                ...
                <div className='sub-admin-right'>
                    <div className='sub-admin-right-form'>
                        <p>Search</p>
                        <div className='sub-admin-right-form-input'>
                            <input type="text" placeholder='Search...'/>
                            <button>Search</button>
                        </div>
                    </div>

                    <div className='sub-admin-right-bottom'>
                        <h3 className='sub-admin-right-list-title'>Recent Posts</h3>
                        <ul className='sub-admin-right-list'>
