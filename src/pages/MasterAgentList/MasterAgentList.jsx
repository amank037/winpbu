...
function MasterAgentList() {
  return (
    <div>
        <div className='master-agent-div2'>
            <div className='master-agent-container'>
                <div className='master-agent-left'>
                    <div className='master-agent-left-top'>
                        <img className='master-agent-img' src="https://winpibu.com/wp-content/uploads/2025/03/master-agent-1.jpg" alt="" />
                        <h2 className='master-agent-left-top-title'>এজেন্ট কে ফোন নাম্বার দিয়ে খুঁজুন</h2>
                        <p className='master-agent-left-top-date'>January 31, 2025</p>
                    </div>

                    <p className='master-agent-left-form-title'>এজেন্ট এর আইডি নাম্বার দিয়ে খুজুনঃ</p>

                    <div className='master-agent-left-form'>
                        <AgentForm />
                    </div>

                    <div className='master-agent-left-desc'>
                    ...
                    <div className='master-agent-left-table'>
                        <table>
                            <thead>
                                <tr>
                                    <th>ID NO</th>
                            ...
                            <tbody>
                                {listData.map((item, index) => (
                                    <tr key={index}>
                                        ...
                                        <td>
                                            <a href=''>
                                                <img className='master-agent-left-table-wa-img' 
                ...
                <div className='master-agent-right'>
                    <div className='master-agent-right-form'>
                        <p>Search</p>
                        <div className='master-agent-right-form-input'>
                            <input type="text" placeholder='Search...'/>
                            <button>Search</button>
                        </div>
                    </div>

                    <div className='master-agent-right-bottom'>
                        <h3 className='master-agent-right-list-title'>Recent Posts</h3>
                        <ul className='master-agent-right-list'>
